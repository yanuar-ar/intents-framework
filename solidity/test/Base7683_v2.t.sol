...
// import { OrderData, OrderEncoder } from "../src/libs/OrderEncoder_v2.sol";
// import { Base7683_v2 } from "../src/Base7683_v2.sol";
...
// contract Base7683ForTest is Base7683_v2 {
...
//     constructor(address _permit2, uint32 _local, uint32 _remote) Base7683_v2(_permit2) {
//         _origin = _local;
...
//         orderData = OrderEncoder.decode(resolvedOrder.fillInstructions[0].originData);
//     }
...
//         address sender,
//         address receiver,
//         Base7683_v2.OrderStatus expectedStatus
//     )
//         internal
//         view
//     {
//         OrderData memory savedOrderData = orderDataById(orderId);
//         Base7683_v2.OrderStatus status = base.orderStatus(orderId);
...
//         assertEq(OrderEncoder.encode(savedOrderData), OrderEncoder.encode(orderData));
//         assertOrder(orderId, orderData, balancesBefore, inputToken, user, address(base), Base7683_v2.OrderStatus.OPENED);
//     }
...
//         // assertOrder(orderId, orderData, balancesBefore, outputToken, vegeta, karpincho,
//         // Base7683_v2.OrderStatus.FILLED);
