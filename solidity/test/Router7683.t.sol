...
contract Router7683ForTest is Router7683 {
    constructor(address _mailbox) Router7683(_mailbox) {}
...
contract Router7683BaseTest is Test {
    ...
    {
        Router7683ForTest implementation = new Router7683ForTest(address(_mailbox));
